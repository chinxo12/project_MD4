...
public interface OrderDetailRepository extends JpaRepository<OrderDetail,Integer> {
    ...
    List<OrderDetail> findByUsers_UserIdAndAndOrderStatus(int id,boolean status);

    @Query(value = "select o.oderDetailId, o.userId,o.productDetailId,o.price,o.quantity,o.createDate,o.orderStatus,o.totalPrice\n" +
    ...
    List<OrderDetail> getOrderForShopByStatus(@Param("uId") int id,@Param("status") boolean status);
}
